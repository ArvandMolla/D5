...
me.skills = ["nothing1", "nothing2", "nothing3"]
...
//why ternary operator dosnt work?
...
console.log(splitMe("I love codinggggg"))
...
console.log(deleteOne("asdkjhsdaf", false))
...
const onlyLetters = function(s2){
   
    return s2.replace(/[0-9]/g, '')
}
console.log(onlyLetters("I have 6 cats"))
...
console.log(isThisAnEmail("kjhsdf@kjhsdf.com"))
...
const rollTheDices = function(par){
...
const howManyDays = function(a){
    let givenDate = new Date(a)
    let today = new Date()
    let timeDifference = today.getTime() - givenDate.getTime()
    return (timeDifference / (1000 * 3600 * 24))
}

console.log(howManyDays("01/30/2021"))
...
const isTodayMyBirthday = function(){
    const myBirthday = new Date("03/12/2021")
    let today = new Date()
    today.setHours(0,0,0,0)
    today.setFullYear(0)
    myBirthday.setFullYear(0)
    if(today.valueOf() === myBirthday.valueOf()){
        return true
    } else {
        return false
    }
...
const myObject2 = {name: "asd", lastname: "asdlfkj", score: 12}

const deleteProp = function (obj, st){
    
    delete obj[st]
    return obj
}

console.log(deleteProp(myObject2, "score"))
...
const onlyInThisMillennium = function(){
    ...
    for (let i = 0; i < movies.length; i++){
        ...
        if(movies[i].Year >= 2000){
            arrayOfmovies.push(movies[i].Title)
